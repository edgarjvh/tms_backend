...
class CarrierUnloadedConsigneeMailable extends Mailable
{
     ...
     * @return void
     */
    public function __construct($carrier_name, $consignee_name, $consignee_city, $consignee_state, $user_first_name, $user_last_name, $order_number, $company_name, $recipient_to, $recipient_cc, $recipient_bcc)
    {
    ...
    public function build()
    {
        return $this
            ...
            ->subject("Delivery - $this->order_number")
            ->view('mails.rate-conf.customer_carrier_unloaded_consignee');
    }
}
