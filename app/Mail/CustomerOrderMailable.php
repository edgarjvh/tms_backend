...
class CustomerOrderMailable extends Mailable
{
    ...
    public function build()
    {
        return $this
            ...
            ->subject("Order $this->order_number")
            ->attachData($this->pdf->output(), "Order-$this->order_number.pdf", ['mime' => 'application/pdf'])
            ->view('mails.rate-conf.customer_order_template');
    }
}
