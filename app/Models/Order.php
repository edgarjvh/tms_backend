...
class Order extends Model
{
    ...
    protected $appends = ['total_loaded_events', 'total_delivered_events', 'total_customer_rating', 'total_carrier_rating', 'distance_mi', 'distance_km'];
