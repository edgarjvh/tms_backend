...
<div class="main-container">
    ...
    <div class="page-block" style="width: 100%;">
        <div style="font-size: 0.83rem; line-height: 0.83rem;text-align: center;">
            Thank you for allowing <span class="red-content-h" style="font-size: 0.83rem; font-weight: bold; font-style: italic">{{$order->company_name}}</span>
        ...
        <div style="font-size: 0.83rem; line-height: 0.83rem;text-align: center;">
            Don’t hesitate to contact <span class="red-content-h" style="font-size: 0.83rem; font-weight: bold; font-style: italic">{{$order->user_first_name}}</span>
            <span class="red-content-h" style="font-size: 0.83rem; font-weight: bold; font-style: italic">{{$order->user_last_name}}</span> at
            <span class="red-content-h" style="font-size: 0.83rem; font-weight: bold; font-style: italic">{{$order->user_phone}}</span> if you
            have any questions.
        </div>
